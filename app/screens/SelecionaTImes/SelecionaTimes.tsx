...
export function SelecionaTimes() {
    ...
    async function handleNavigation(acao: string) {
        if(acao === 'pular') {
            ...
            await axios.post(`${APP_URL}/api/timesUsuarios/cadastraTimesUsuario/${usuario.id}`, body);
            navigator.navigate('Home');
        }
    }
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.card}>
                <View style={styles.skipView}>
                    ...
                    <IconButton
                        icon={<Ionicons name="md-arrow-forward-circle-outline" size={15}/>}
                        onPress={() => handleNavigation('pular')}
                    />
                </View> 
                ...
                <View style={styles.footer}>
                    ...
                    <Button style={styles.button} variant="outline" size="md" backgroundColor={COLORS.COLOR_GOLD4}
                        ...
                        onPress={() => handleNavigation('confirmar')}
                        >
